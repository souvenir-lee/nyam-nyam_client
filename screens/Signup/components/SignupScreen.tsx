...
export default function SigninScreen({ email, password, passwordCheck, username, handleEmailChange, 
    handlePasswordChange, handlePasswordCheckChange, handleUsernameChange,
    handleNextButtonPress }: SignupScreenProps){
